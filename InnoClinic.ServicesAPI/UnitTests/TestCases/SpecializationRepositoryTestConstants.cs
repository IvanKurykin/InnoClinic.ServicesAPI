...
public static class SpecializationRepositoryTestConstants
{
    ...
    public const string UseDbSql = "USE SpecializationTestDb;";
    ...
    public const string CloseConnectionsSql = "ALTER DATABASE SpecializationTestDb SET SINGLE_USER WITH ROLLBACK IMMEDIATE;";
    public const string DropDbSql = "DROP DATABASE SpecializationTestDb;";
}